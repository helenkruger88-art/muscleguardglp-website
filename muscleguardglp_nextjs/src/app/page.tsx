...
export default function HomePage() {
  const features = [
    ...
    // v1.2 (2026-07-14) — Meal Planner flagship promoted to hero row.
    { icon: '🍽', title: 'Meal Planner (Pro)', hero: true, body: 'A 7-day meal plan built from a curated GLP-1 and muscle-preservation recipe library. Choose 3, 4, or 5 meals a day. The planner respects your daily protein target within your carb and fat caps — nudges you to add a shake if the day can\'t reach protein. Swap any meal, regenerate any week, export the shopping list as a PDF.' },
    ...
    { icon: '🤢', title: 'Nausea Protocol', hero: false, body: 'Safe Bites, hydration target, sleep guidance, and automatic symptom logging — for shot-day weeks. Escalating check-in pings at 90 minutes and 6 hours so a forgotten episode always gets a nudge.' },
    ...
    { icon: '📈', title: 'Trends', hero: false, body: 'The doctor view. Calendar of pillar adherence, protein and training charts, body transformation read, symptom timeline broken into top symptoms + dose-cycle patterns, safety flags for rapid loss and dose-frequency anomalies.' },
    { icon: '🤖', title: 'Pattern Read (Pro)', hero: false, body: 'Weekly AI verdict on what is trending up and down across protein, training, hydration, weight, fibre, mood, symptoms, carbs and fats. Grade transparency — see exactly which pillar is dragging your grade down. Safety-aware — rapid weight loss overrides "keep the rhythm" with protein-and-hydration guidance instead.' },
    // v1.2 (2026-07-14) — Correlations engine shipped.
    { icon: '🔗', title: 'Correlations (Pro)', hero: false, body: 'Spearman rank correlations across your own log. Surfaces habit pairs like hydration-and-energy, protein-and-loss-rate, injection-day-and-mood — from day 14 with an early-signal tier, or day 21 for clear patterns. When a pair does not correlate, we say so honestly instead of pretending it does.' },
    // v1.2 (2026-07-14) — Cycle Signals for weekly-injector Pro users.
    { icon: '📊', title: 'Cycle Signals (Pro)', hero: false, body: 'For weekly injectors — which day of your dose cycle is your best day and which is your hardest, plus a per-cycle diary of feeling and symptom averages. Answers the question every GLP-1 user asks: "when in the week do I feel worst?"' },
    { icon: '📷', title: 'Snap to Log + Label Scan (Pro)', hero: false, body: 'Point the camera at a plate or a nutrition label — Gemini identifies the foods and macros. Open Food Facts for barcoded packages. Transparently disclosed provenance on every entry.' },
    ...
    { icon: '📄', title: 'Clinical Summary PDF', hero: false, body: 'Your GLP-1 Journey, formatted for a 10-minute doctor visit. Medication log, body comp trajectory, macros, training, symptoms, pattern write-ups, and a Clinical Concerns section for any active safety flags — so the doctor sees urgent items first.' },
    { icon: '⚕', title: 'Symptom Log', hero: false, body: '17 categories with severity 0 to 3, red-flag detection, and a symptom timeline that shows top symptoms and dose-cycle patterns at a glance.' },
